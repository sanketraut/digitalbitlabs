...
$fields = [
    'author_name' =>            ['Your name',             'Sanket Raut',                                                ''],
    'author_github_username' => ['Your Github username',  'sanketraut in https://github.com/sanketraut',       ''],
    'author_email' =>           ['Your email address',    'sanket@digitalbit.in',                                                ''],
    'author_twitter' =>         ['Your twitter username', 'digitalbitlabs',                                                '@sanketraut'],
    'author_website' =>         ['Your website',          'https://digitalbit.in',                                                'https://github.com/sanketraut'],

    'package_vendor' =>         ['Package vendor',        'Digitalbit in https://github.com/sanketraut/formbuilder',   'sanketraut'],
    'package_name' =>           ['Package name',          'Forms in https://github.com/sanketraut/formbuilder',  ''],
    'package_description' =>    ['Package very short description',   'Form Builder package for Laravel 5.5',                                     ''],

    'psr4_namespace' =>         ['PSR-4 namespace',       'usually, Digitalbit\\Forms',                        'Digitalbit\\Forms'],
];
